...
namespace TowerDefence
{
	...
	*/
	...
	public:
		...
		/*!
		\brief constructor initializing the graphics for object.
		\param object - graphics for this object
		*/
